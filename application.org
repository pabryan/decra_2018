...
I obtained a Ph.D. at the Australian National University, Canberra in August 2012. My thesis arose from observations I made during a summer research project and in my honours project. The observation lead to three papers published jointly in the top journals Crelle, Calc. Var. PDE. and Comm. Anal. Geom. with my advisor Prof. Ben Andrews. My Ph.D. thesis studied the isoperimetric profile and differential inequalities underlying the techniques used in the three aforementioned papers. I extended these techniques to broader situations, giving a unifying proof that the Ricci flow deforms any initial metric on closed surfaces to a metric of constant curvature. This work established internationally recognized foundational techniques in the analysis of geometric evolution equations, forming the backbone of the Isoperimetric Comparison section of this proposal.
