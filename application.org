...
****** *Aim 2* $k^{\alpha}$ distance comparison (joint with Prof. Ben Andrews)
...
****** *Aim 3* Curve Shortening of Networks (joint with Prof. Mariel \saez)
...
***** The Cross Curvature Flow (joint with Dr. Mohammad Ivaki and Dr. Julian Scheuer)
Let
\[
...
****** *Aim 1* Comparisons for the Einstein volume under the Cross Curvature Flow.
...
- Deal with non-Codazzi
- Modulus of continuity may handle non-linearities better
