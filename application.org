...
1. Obtain comparisons of the isoperimetric profile with radial models,
1. Prove the multiplicity one conjecture for Curve Shortening of Networks,
1. Prove a Grayson theorem for Homogeneous Curve Shortening Flow.
...
******* Comparisons and asymptotic singularity formation of planar curve flows

****** *Aim 2* $k^{\alpha}$ distance comparison.
- Prove a Grayson type theorem
- distance comparison for approximating flows
- works for $\alpha \in (0, 1)$
- circles are stable for $(1/3, 1)$ and unstable otherwise
- need a-priori estimates as in the other part of the project
****** *Aim 3* Curve Shortening of Networks
- distance comparison works
- networks introduce nodal speeds but have the correct sign with convexity/symmetry
- multiple self-similar solutions exist
- comparisons and curvature bounds are necessary
- compared with smooth CSF, moduli space of self-simlar solutions is more complex
******* Notes							   :noexport:
...
******* The XCF and hyperbolic manifolds
