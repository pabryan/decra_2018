...
I was a visiting researcher at the Beijing International Centre for Mathematics from May 2012 to September 2012, during which time I established connections with leading Chinese mathematicians such as Professor Gang Tian. China is an emerging research power, and I was very fortunate to have spent time at two of China's most prestigious universities, Peking University and Tsinghua University. It was in Beijing that my understanding of isoperimetric problems began to take shape.

From July 2012 until July 2015, I held the prestigious Stephan E. Warschawski Visiting Assistant Professorship at the University of California, San Diego. This is a position awarded to top upcoming mathematicians from all fields. This position did not come with any specific mentor, though I benefited greatly from the experience and advice of Professors Bennett Chow and Lei Ni. During that time, I focused almost exclusively on teaching, delivering some nineteen courses, and research supervision, supervising a Ph.D. thesis, an undergraduate research project and conducting an undergraduate research seminar. As such my research output was reduced to two papers written during that period. Both papers were published in 2016, one arising from the supervison of Prof. Bennett Chow's student Dr. Janelle Louise and the other with me as sole author and published in the highly respected journal, Annali Della Scuola Normale Superiore Di Pisa - Classe Di Scienze.

Following on, I briefly returned to the ANU in Australia as a Research Fellow working with Professor Ben Andrews. During this time I reestablished contacts at Australian Universities, and consolidated my research plans for the forthcoming year. In this period I was invited to Monash University and began a project with ARC Future Fellow, Julie Clutterbuck.

I then took up a highly sought after Riemann Fellowship at Leibniz University in Hannover, Germany where I built further research connections primarily with Professor Knut Smoczyck. Next, I began a twelve month postdoctoral potion at the University of Warwick under the supervision of Peter Topping, a leader in the field of Geometric Analysis. I further developed research networks with senior researchers such as Professor Mario Micalef as well as upcoming researchers such as Doctors Andrea Mondino and Ben Sharp. I also visited Pontificia Universidad Católica de Chile and began a collaboration with Professor Mariel Saez. I have now returned to Australia, with a Research Fellow position working with Professor Joseph Grotowski at the University of Queendland, broadening my research network and beginning yet another collaboration.

Over the eighteen month period where I focused research after leaving San Diego I began a very fruitful collaboration with Doctors Mohammad Ivaki and Julian Scheuer. This collaboration produced five publications, two of which have been accepted for publication in the quality journals Analysis & PDE and Communications in Analysis and Geometry. The remaining papers have been submitted to leading journals such as the Journal of Differential Geometry, the Journal of the European Mathematical Society.

I have worked alongside leading researchers in the field of Geometric Analysis, established international networks and began highly fruitful collaborations. I experienced an understanably slow period of research whilst teaching, but since then have clearly reestablished a strong research program, resulting in publiscations submitted and accepted by top journals as well as several further publications in preparation arising from the international collaborations I established. The following table shows y research/teaching load over the past five years, as a fraction of full time load, highlighting in particular the heavy teaching load in my early career and the recent return to a research focus:
...
I have been working on the connection between isoperimetric problems and curvature flows since my Ph.D. thesis. Using variational techniques, I discovered the underlying structure behind prior investigations \cite{MR1369140,MR1369139,MR1656553} in papers published in the finest and highly ranked journals. This structure manifests itself through a viscosity differential inequality for the /isoperimetric profile/ of a surface and is also described in \cite{Bryan}. One of the referees for my thesis described the exposition as "one of the clearest explanations of the isoperimetric profile".
  ...
  Beginning with the paper \cite{bryanlouie}, I have turned my attention to the question of analysing ancient solutions, in particular classifying such solutions.
...
- Mention lecture notes based on comparison work.
- Ancient solutions and the Harnack.
...
This project has aims straddling three broad, interrelated programs: 

1. Isoperimetric comparisons,
2. estimates for fully non-linear geometric evolution equations, and
...
- XCF
  - Use Codazzi to simplify the topology?
  - 3d is special - a non-vanishing vector field corresponds to a non-vanishing 2-plane.
  - But exactness is not quite as straight forward as with Gauss-Bonnet but something should be there.
- 3D Ricci Flow
- Kahler Rici Flow
***** Optimal Transport Shape Tracking Techniques
- Optimal map
...
***** _Estimates for fully non-linear geometric evolution equations_
****** Harnack estimates.
- Build on our work mentioning Julian's grant.
...
- Works also in the viscosity setting by Xioalong and Kui's works. Could be quite powerful for obtaining estimates particularly in the mean convex MCF setting.
...
***** _Singularities, symmetries and ancient solutions of fully non-linear geometric evolution equations_
