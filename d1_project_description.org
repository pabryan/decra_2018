...
\]
This flow has greater non-linearity than the Curve Shortening Flow, and owing to the absolute value, has non-smooth speed for non-convex curves. Convergence results for convex curves have been obtained \cite{MR1255274,MR1660843} but the general embedded case remains open.
